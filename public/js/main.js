...
function documentReadyInit() {
  ...
  jQuery("form.contact-form").on("submit", function (e) {
    ...
    var ajax = jQuery
      .post("contact-form.html", request)
      .done(function (data) {
        jQuery($form)
          .find('[type="submit"]')
          .attr("disabled", false)
...
function windowLoadInit() {
  ...
  if (jQuery().flexslider) {
    var $introSlider = jQuery(
      ".intro_section .flexslider, .mainslider .flexslider"
    );
